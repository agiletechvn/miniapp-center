...
const sample = {
	...
	package: {
		appVersion: '1.2.3',
		blobUrl:
			'https://codepush.blob.core.windows.net/storagev2/cL-_y8QTVNNiP-GcJ9_5CJsxfcQL4yecGHaB-',
		description: '',
		diffPackageMap: {
			bbc259d25bd31685e9502d8150523614d8f98cf84451caea8e7774ba897e72c4: {
				size: 174779,
				url:
					'https://codepush.blob.core.windows.net/storagev2/2OtuOThIY8G4we037oSeiQ9S7A1-4yecGHaB-'
			}
		},
		isDisabled: false,
		isMandatory: false,
		packageHash:
			'2b87aaa5d8dd9ea147dcd3933ba494fcc1fb929f4fb74c3fd3a7ceabdb337f26',
		size: 203914,
...
export default class Package extends Component {
	...
	renderPackage() {
		...
		return (
			<div className="list-group-item d-flex justify-content-between">
				<GroupItem label="File" className="text-left">
					<dl className="dl-horizontal dl-horizontal-ota">
						...
						<dt>Hash</dt>
						<dd>
							<Copy text={packageHash} />
						</dd>
					</dl>
				</GroupItem>
				<GroupItem label="Release" className="text-left">
					<dl className="dl-horizontal dl-horizontal-ota">
						<dt>By</dt>
						<dd>{releasedBy}</dd>
						<dt>Time</dt>
	...
	render() {
		return (
			<Body>
				{this.props.depKey ? (
					<GroupItem label={`Deployment Key [${this.props.name}] `}>
