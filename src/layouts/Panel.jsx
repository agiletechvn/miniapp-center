...
export const Heading = ({
	...
	children,
	className,
	labelClass = 'panel-title pull-left'
}) => (
	<div className={classNames('panel-heading clearfix', className)}>
...
export const Footer = ({ children }) => (
	<div className="panel-footer clearfix">{children}</div>
);
...
export const Page = ({ label, children, ...rest }) => (
	<div {...rest}>
